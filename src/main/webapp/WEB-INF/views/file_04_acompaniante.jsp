...
<html>
	<head>
		...
		<title>Programa Acompa&ntilde;antes</title>
		<link rel="stylesheet" href="<c:url value="/resources/css/css_00_menu.css"/>" type="text/css"></link>
		<link rel="stylesheet" href="<c:url value="/resources/css/css_04_acompaniante.css"/>" type="text/css"></link>
			...
			<div id="div_encabezado">
				...
				<div id="div_menu">
					<form name="form_menu">
						...
						<div id="div_menu_acompaniante">
							<img alt="" src="<c:url value="/resources/image/mnu_04_activo.png"/>"/>
						</div>
